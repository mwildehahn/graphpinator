    ...
    protected function getFieldDefinition(): \Graphpinator\Field\ResolvableFieldSet {
        return new \Graphpinator\Field\ResolvableFieldSet(dict[
            'kind' => \Graphpinator\Field\ResolvableField::create(
                ...
                static function(Definition $definition, ?bool $_): mixed {
            ...
            'name' => \Graphpinator\Field\ResolvableField::create(
                ...
                static function(Definition $definition, ?bool $_): ?string {
            ...
            'interfaces' => \Graphpinator\Field\ResolvableField::create(
                'interfaces',
                $this->notNull()->list(),
                static function(Definition $definition, ?bool $_): ?\Graphpinator\Type\InterfaceSet {
            ...
            'possibleTypes' => \Graphpinator\Field\ResolvableField::create(
                'possibleTypes',
                $this->notNull()->list(),
                function(Definition $definition, ?bool $_): ?\Graphpinator\Type\TypeSet {
